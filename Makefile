...
.PHONY: help fmt test test-unit test-storybook test-browser validate build generate release check-dist run
...
validate: ## The gate — exactly what CI runs: surface guard, version parity, lint, tests, builds, artifact checks.
	pnpm validate
