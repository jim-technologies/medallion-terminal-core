export type BiShape = 'SHAPE_UNSPECIFIED' | 'SHAPE_TIMESERIES' | 'SHAPE_CANDLES' | 'SHAPE_TABLE' | 'SHAPE_METRIC' | 'SHAPE_GAUGE' | 'SHAPE_HEATMAP' | 'SHAPE_EVENTS' | 'SHAPE_DISTRIBUTION' | 'SHAPE_TEXT' | 'SHAPE_ORDERBOOK' | 'SHAPE_PAIRED_GRID' | 'SHAPE_EMBED' | 'SHAPE_ASSET_CATALOG' | 'SHAPE_OBJECT' | 'SHAPE_GRAPH' | 'SHAPE_REPOSITORY' | 'SHAPE_RECORD_SET' | 'SHAPE_GEO' | 'SHAPE_MEDIA' | 'SHAPE_CONVERSATION';
