...
var L = (e, t) => l(() => e().then((e) => ({ default: e[t] }))), ue = /* @__PURE__ */ new Map([
	["timeseries", L(() => import("./Timeseries-FKwgM9uk.js").then((e) => e.n), "Timeseries")],
	["candlestick", L(() => import("./Candlestick-BrLHfAl7.js").then((e) => e.n), "Candlestick")],
	["table", L(() => import("./DataTable-D9BHxv9Q.js").then((e) => e.n), "DataTable")],
	["metric", L(() => import("./Metric-CsN3_xvB.js").then((e) => e.n), "Metric")],
	["text", L(() => import("./Text-D2dVGNPM.js").then((e) => e.n), "Text")],
	["conversation", L(() => import("./ConversationImpl-D718CbFB.js"), "ConversationImpl")],
	["prompt", L(() => import("./Prompt-r0opnh7x.js").then((e) => e.n), "Prompt")],
	["gauge", L(() => import("./Gauge-DKUAN2Fd.js").then((e) => e.n), "Gauge")],
	["distribution", L(() => import("./Distribution-3mVozChx.js").then((e) => e.n), "Distribution")],
	["heatmap", L(() => import("./Heatmap-DyT_nYe0.js").then((e) => e.n), "Heatmap")],
	["events", L(() => import("./Events-JHXfiPfF.js").then((e) => e.n), "Events")],
	["catalog", L(() => import("./Catalog-DM5fHEbX.js").then((e) => e.n), "Catalog")],
	["asset_catalog", L(() => import("./AssetCatalog-BIy4gTOq.js").then((e) => e.n), "AssetCatalog")],
	["object_view", L(() => import("./ObjectView-BU1nWtPC.js").then((e) => e.n), "ObjectView")],
	["code_browser", L(() => import("./CodeBrowser-CJG7KOfV.js").then((e) => e.n), "CodeBrowser")],
	["record_grid", L(() => import("./RecordGrid-ChBNMIzC.js").then((e) => e.n), "RecordGrid")],
	["record_board", L(() => import("./RecordBoard-BZconZR4.js").then((e) => e.n), "RecordBoard")],
	["record_calendar", L(() => import("./RecordCalendar-BPjnLs6I.js").then((e) => e.n), "RecordCalendar")],
	["record_form", L(() => import("./RecordForm-DXSsA8Wa.js").then((e) => e.n), "RecordForm")],
	["action_form", L(() => import("./ActionForm-yD6FwP03.js").then((e) => e.n), "ActionForm")],
	["orderbook", L(() => import("./OrderBook-Duz-VUl9.js").then((e) => e.n), "OrderBook")],
	["depth_chart", L(() => import("./DepthChart-D5qn-ipO.js").then((e) => e.n), "DepthChart")],
	["paired_grid", L(() => import("./PairedGrid-Bghp0yfH.js").then((e) => e.n), "PairedGrid")],
	["trade", L(() => import("./Trade-BKieMOYf.js").then((e) => e.n), "Trade")],
	["ticker", L(() => import("./Ticker-obBK9Gxf.js").then((e) => e.n), "Ticker")],
	["volume_profile", L(() => import("./VolumeProfile-BjOePa1k.js").then((e) => e.n), "VolumeProfile")],
	["stat_strip", L(() => import("./StatStrip-Cjlf45zS.js").then((e) => e.n), "StatStrip")],
	["bar_chart", L(() => import("./BarChart-BDD509IH.js").then((e) => e.n), "BarChart")],
	["scatter", L(() => import("./Scatter-y1kiYB22.js").then((e) => e.n), "Scatter")],
	["clock", L(() => import("./Clock-Cc9ABoWJ.js").then((e) => e.n), "Clock")],
	["treemap", L(() => import("./Treemap-R3iUdKPf.js").then((e) => e.n), "Treemap")],
	["image", L(() => import("./Image-DKZKu2io.js").then((e) => e.n), "Image")],
	["iframe", L(() => import("./Iframe-F-DYJ6A0.js").then((e) => e.n), "Iframe")],
	["histogram", L(() => import("./Histogram-CsYS5dNZ.js").then((e) => e.n), "Histogram")],
	["section", L(() => import("./Section-Cpjr_7EV.js").then((e) => e.n), "Section")],
	["area_chart", L(() => import("./AreaChart-BzOSLAW2.js").then((e) => e.n), "AreaChart")],
	["slider", L(() => import("./Slider-BCjBvOpZ.js").then((e) => e.n), "Slider")],
	["select", L(() => import("./Select-BI1RxlQT.js").then((e) => e.n), "Select")],
	["boxplot", L(() => import("./Boxplot-CNcFoqB5.js").then((e) => e.n), "Boxplot")],
	["radar", L(() => import("./Radar-DcZDflha.js").then((e) => e.n), "Radar")],
	["dag", L(() => import("./Dag-LkjUq9uh.js").then((e) => e.n), "Dag")],
	["geo_map", L(() => import("./GeoMap-CI-cXyC8.js").then((e) => e.n), "GeoMap")],
	["media_gallery", L(() => import("./MediaGalleryImpl-Czx6_0Kw.js"), "MediaGalleryImpl")],
	["multi_select", L(() => import("./MultiSelect-DUP0I4kM.js").then((e) => e.n), "MultiSelect")],
	["json", L(() => import("./Json-Bt9fPJe1.js").then((e) => e.n), "Json")],
	["sparkline", L(() => import("./Sparkline-BK8oy3cm.js").then((e) => e.n), "Sparkline")],
	["action_log", L(() => import("./ActionLog-Wts6MjvM.js").then((e) => e.n), "ActionLog")],
	["alert_log", L(() => import("./AlertLog-CMwPzxRI.js").then((e) => e.n), "AlertLog")],
	["tape", L(() => import("./Tape-D4kLU-_q.js").then((e) => e.n), "Tape")],
	["file_browser", L(() => import("./FileBrowser-D8r2JQIH.js").then((e) => e.n), "FileBrowser")]
