import { l as e, n as t, t as n, u as r } from "./States-CBV4O5lL.js";
...
var L = (e, t) => l(() => e().then((e) => ({ default: e[t] }))), ue = /* @__PURE__ */ new Map([
	["timeseries", L(() => import("./Timeseries-iLBGHht4.js").then((e) => e.n), "Timeseries")],
	["candlestick", L(() => import("./Candlestick-CX3dpJlM.js").then((e) => e.n), "Candlestick")],
	["table", L(() => import("./DataTable-DHZzq3CC.js").then((e) => e.n), "DataTable")],
	["metric", L(() => import("./Metric-CsN3_xvB.js").then((e) => e.n), "Metric")],
	["text", L(() => import("./Text-Bta4xvUi.js").then((e) => e.n), "Text")],
	["conversation", L(() => import("./ConversationImpl-DrY9nWRh.js"), "ConversationImpl")],
	["prompt", L(() => import("./Prompt-8WhAeX9v.js").then((e) => e.n), "Prompt")],
	["gauge", L(() => import("./Gauge-Ir4sdbLb.js").then((e) => e.n), "Gauge")],
	["distribution", L(() => import("./Distribution-DA_IucAY.js").then((e) => e.n), "Distribution")],
	["heatmap", L(() => import("./Heatmap-gUi7-RtA.js").then((e) => e.n), "Heatmap")],
	["events", L(() => import("./Events-BsSMuu0N.js").then((e) => e.n), "Events")],
	["catalog", L(() => import("./Catalog-Bb0_jbUx.js").then((e) => e.n), "Catalog")],
	["asset_catalog", L(() => import("./AssetCatalog-BY3tALPb.js").then((e) => e.n), "AssetCatalog")],
	["object_view", L(() => import("./ObjectView-BZypGoVb.js").then((e) => e.n), "ObjectView")],
	["code_browser", L(() => import("./CodeBrowser-DgYeqdoT.js").then((e) => e.n), "CodeBrowser")],
	["record_grid", L(() => import("./RecordGrid-LzfPzMuS.js").then((e) => e.n), "RecordGrid")],
	["record_board", L(() => import("./RecordBoard-Cwbk9cwi.js").then((e) => e.n), "RecordBoard")],
	["record_calendar", L(() => import("./RecordCalendar-CX2fsILo.js").then((e) => e.n), "RecordCalendar")],
	["record_form", L(() => import("./RecordForm-D7tawYRm.js").then((e) => e.n), "RecordForm")],
	["action_form", L(() => import("./ActionForm-BcIBbR16.js").then((e) => e.n), "ActionForm")],
	["orderbook", L(() => import("./OrderBook-BnH5L1Ca.js").then((e) => e.n), "OrderBook")],
	["depth_chart", L(() => import("./DepthChart-uRPCsIQV.js").then((e) => e.n), "DepthChart")],
	["paired_grid", L(() => import("./PairedGrid-91bGbE9B.js").then((e) => e.n), "PairedGrid")],
	["trade", L(() => import("./Trade-BhTtX1Y-.js").then((e) => e.n), "Trade")],
	["ticker", L(() => import("./Ticker-CN16t7al.js").then((e) => e.n), "Ticker")],
	["volume_profile", L(() => import("./VolumeProfile-CalJ3Bsl.js").then((e) => e.n), "VolumeProfile")],
	["stat_strip", L(() => import("./StatStrip-R0ARnleB.js").then((e) => e.n), "StatStrip")],
	["bar_chart", L(() => import("./BarChart-v_Nh9gWW.js").then((e) => e.n), "BarChart")],
	["scatter", L(() => import("./Scatter-Ddb4PHhD.js").then((e) => e.n), "Scatter")],
	["clock", L(() => import("./Clock-Cc9ABoWJ.js").then((e) => e.n), "Clock")],
	["treemap", L(() => import("./Treemap-BMNOdSvx.js").then((e) => e.n), "Treemap")],
	["image", L(() => import("./Image-7YjM7pjh.js").then((e) => e.n), "Image")],
	["iframe", L(() => import("./Iframe-tA-xseJq.js").then((e) => e.n), "Iframe")],
	["histogram", L(() => import("./Histogram-C6dswCih.js").then((e) => e.n), "Histogram")],
	["section", L(() => import("./Section-Cpjr_7EV.js").then((e) => e.n), "Section")],
	["area_chart", L(() => import("./AreaChart-lR36cDna.js").then((e) => e.n), "AreaChart")],
	["slider", L(() => import("./Slider-nXuwSF4I.js").then((e) => e.n), "Slider")],
	["select", L(() => import("./Select-y_Kasqhh.js").then((e) => e.n), "Select")],
	["boxplot", L(() => import("./Boxplot-DExblSSV.js").then((e) => e.n), "Boxplot")],
	["radar", L(() => import("./Radar-ChAEdAk7.js").then((e) => e.n), "Radar")],
	["dag", L(() => import("./Dag-CCmZJb3X.js").then((e) => e.n), "Dag")],
	["geo_map", L(() => import("./GeoMap-QUlyTAOU.js").then((e) => e.n), "GeoMap")],
	["media_gallery", L(() => import("./MediaGalleryImpl-CN_UFumZ.js"), "MediaGalleryImpl")],
	["multi_select", L(() => import("./MultiSelect-CVyBcLfb.js").then((e) => e.n), "MultiSelect")],
	["json", L(() => import("./Json-BKKn23_5.js").then((e) => e.n), "Json")],
	["sparkline", L(() => import("./Sparkline-Bn2xUlag.js").then((e) => e.n), "Sparkline")],
	["action_log", L(() => import("./ActionLog-BgtDJFsU.js").then((e) => e.n), "ActionLog")],
	["alert_log", L(() => import("./AlertLog-DM0QIJRA.js").then((e) => e.n), "AlertLog")],
	["tape", L(() => import("./Tape-NkPjcxcB.js").then((e) => e.n), "Tape")],
	["file_browser", L(() => import("./FileBrowser-CtUv4aKk.js").then((e) => e.n), "FileBrowser")]
