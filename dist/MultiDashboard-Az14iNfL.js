...
import { l as a, n as o, o as s, s as c, t as l } from "./sourceError-GEQl_6YF.js";
		...
		if (e.stream === "connect") {
			let t = !1, r = new AbortController(), i = async () => {
				if (!t) try {
					...
					if (!i.body) throw new l("Stream response has no body", { kind: "unavailable" });
					...
					!t && e instanceof Error && !A(e) && p(a(e));
				} finally {
					if (!t) {
						S(!1);
						let e = O.current;
			...
			let t = null, n = !1, r = () => {
				n || (t = new EventSource(e.url), t.onopen = () => {
					...
					try {
						...
						p(new l("Failed to parse stream", { kind: "unknown" }));
					}
				}, t.onerror = () => {
					if (t?.close(), S(!1), !n) {
						let e = O.current;
...
var z = (e, t) => h(() => e().then((e) => ({ default: e[t] }))), B = /* @__PURE__ */ new Map([
	["timeseries", z(() => import("./Timeseries-CHvJOGeM.js").then((e) => e.n), "Timeseries")],
	["candlestick", z(() => import("./Candlestick-4dsesd6U.js").then((e) => e.n), "Candlestick")],
	["table", z(() => import("./DataTable-BfWILXnr.js").then((e) => e.n), "DataTable")],
	["metric", z(() => import("./Metric-CsN3_xvB.js").then((e) => e.n), "Metric")],
	["text", z(() => import("./Text-C5oB59tO.js").then((e) => e.n), "Text")],
	["conversation", z(() => import("./ConversationImpl-DOo3uOQy.js"), "ConversationImpl")],
	["prompt", z(() => import("./Prompt-BoT5_HRE.js").then((e) => e.n), "Prompt")],
	["gauge", z(() => import("./Gauge-qLcto8Xc.js").then((e) => e.n), "Gauge")],
	["distribution", z(() => import("./Distribution-Pu1FYlAU.js").then((e) => e.n), "Distribution")],
	["heatmap", z(() => import("./Heatmap-D14S8zKE.js").then((e) => e.n), "Heatmap")],
	["events", z(() => import("./Events-BC8lLEn3.js").then((e) => e.n), "Events")],
	["catalog", z(() => import("./Catalog-BR7bkTw2.js").then((e) => e.n), "Catalog")],
	["asset_catalog", z(() => import("./AssetCatalog-DOaBSY97.js").then((e) => e.n), "AssetCatalog")],
	["object_view", z(() => import("./ObjectView-B4UAMFU3.js").then((e) => e.n), "ObjectView")],
	["code_browser", z(() => import("./CodeBrowser-1D0wdLYC.js").then((e) => e.n), "CodeBrowser")],
	["record_grid", z(() => import("./RecordGrid-CFM18TUk.js").then((e) => e.n), "RecordGrid")],
	["record_board", z(() => import("./RecordBoard-CIHiMG9n.js").then((e) => e.n), "RecordBoard")],
	["record_calendar", z(() => import("./RecordCalendar-5ar7PZVw.js").then((e) => e.n), "RecordCalendar")],
	["record_form", z(() => import("./RecordForm-CugmBhb0.js").then((e) => e.n), "RecordForm")],
	["action_form", z(() => import("./ActionForm-CSIxUall.js").then((e) => e.n), "ActionForm")],
	["orderbook", z(() => import("./OrderBook-BSH1T1_p.js").then((e) => e.n), "OrderBook")],
	["depth_chart", z(() => import("./DepthChart-CEIO3cDS.js").then((e) => e.n), "DepthChart")],
	["paired_grid", z(() => import("./PairedGrid-DTIDt6VG.js").then((e) => e.n), "PairedGrid")],
	["trade", z(() => import("./Trade-1rtiY5p8.js").then((e) => e.n), "Trade")],
	["ticker", z(() => import("./Ticker-BWECrBjv.js").then((e) => e.n), "Ticker")],
	["volume_profile", z(() => import("./VolumeProfile-Ci2PvoL9.js").then((e) => e.n), "VolumeProfile")],
	["stat_strip", z(() => import("./StatStrip-xvRZ0hKY.js").then((e) => e.n), "StatStrip")],
	["bar_chart", z(() => import("./BarChart-HnIcYejc.js").then((e) => e.n), "BarChart")],
	["scatter", z(() => import("./Scatter-DCfM22VP.js").then((e) => e.n), "Scatter")],
	["clock", z(() => import("./Clock-Cc9ABoWJ.js").then((e) => e.n), "Clock")],
	["treemap", z(() => import("./Treemap-C4pzbu-P.js").then((e) => e.n), "Treemap")],
	["image", z(() => import("./Image-4Jtrg7Yk.js").then((e) => e.n), "Image")],
	["iframe", z(() => import("./Iframe-nbY9JCO5.js").then((e) => e.n), "Iframe")],
	["histogram", z(() => import("./Histogram-Dp6_V-VF.js").then((e) => e.n), "Histogram")],
	["section", z(() => import("./Section-Cpjr_7EV.js").then((e) => e.n), "Section")],
	["area_chart", z(() => import("./AreaChart-BuBqCk5W.js").then((e) => e.n), "AreaChart")],
	["slider", z(() => import("./Slider-By6CHl2m.js").then((e) => e.n), "Slider")],
	["select", z(() => import("./Select-BPmRf3BY.js").then((e) => e.n), "Select")],
	["boxplot", z(() => import("./Boxplot-D81_Y-pC.js").then((e) => e.n), "Boxplot")],
	["radar", z(() => import("./Radar-nu1RpfA8.js").then((e) => e.n), "Radar")],
	["dag", z(() => import("./Dag-D1JnhOJ8.js").then((e) => e.n), "Dag")],
	["geo_map", z(() => import("./GeoMap-MB3ozdZf.js").then((e) => e.n), "GeoMap")],
	["media_gallery", z(() => import("./MediaGalleryImpl-BUXyZChV.js"), "MediaGalleryImpl")],
	["multi_select", z(() => import("./MultiSelect-CvdaSD2U.js").then((e) => e.n), "MultiSelect")],
	["json", z(() => import("./Json-Co0xzJFk.js").then((e) => e.n), "Json")],
	["sparkline", z(() => import("./Sparkline-CnQCT8Xg.js").then((e) => e.n), "Sparkline")],
	["action_log", z(() => import("./ActionLog-CDUEuXLn.js").then((e) => e.n), "ActionLog")],
	["alert_log", z(() => import("./AlertLog-DmtXVVRX.js").then((e) => e.n), "AlertLog")],
	["tape", z(() => import("./Tape-DayimFGZ.js").then((e) => e.n), "Tape")],
	["file_browser", z(() => import("./FileBrowser-BguLVdzl.js").then((e) => e.n), "FileBrowser")]
