...
import { At as t, It as n, ft as r } from "./MultiDashboard-CwQKjnza.js";
...
function v(e) {
	...
	let g = Math.max(0, ...s.values()), _ = Math.max(...Array.from(u.values(), (e) => e.length)), v = h * 2 + _ * d + (_ - 1) * m, y = h * 2 + (g + 1) * f + g * (p - f), b = /* @__PURE__ */ new Map();
	for (let [e, t] of u) {
