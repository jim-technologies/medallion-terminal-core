...
var L = (e, t) => s(() => e().then((e) => ({ default: e[t] }))), ce = /* @__PURE__ */ new Map([
	["timeseries", L(() => import("./Timeseries-BPGs5YHw.js").then((e) => e.n), "Timeseries")],
	["candlestick", L(() => import("./Candlestick-DjBhds-_.js").then((e) => e.n), "Candlestick")],
	["table", L(() => import("./DataTable-CGla16Qg.js").then((e) => e.n), "DataTable")],
	["metric", L(() => import("./Metric-CsN3_xvB.js").then((e) => e.n), "Metric")],
	["text", L(() => import("./Text-DCJedTZ_.js").then((e) => e.n), "Text")],
	["conversation", L(() => import("./ConversationImpl-DK80_SKC.js"), "ConversationImpl")],
	["prompt", L(() => import("./Prompt-D3HoDyHZ.js").then((e) => e.n), "Prompt")],
	["gauge", L(() => import("./Gauge-CXMQTxUr.js").then((e) => e.n), "Gauge")],
	["distribution", L(() => import("./Distribution-CPoGUOQv.js").then((e) => e.n), "Distribution")],
	["heatmap", L(() => import("./Heatmap-BQHsSOUq.js").then((e) => e.n), "Heatmap")],
	["events", L(() => import("./Events-BQAYoRg7.js").then((e) => e.n), "Events")],
	["catalog", L(() => import("./Catalog-DCjLeXWe.js").then((e) => e.n), "Catalog")],
	["asset_catalog", L(() => import("./AssetCatalog-BFucmzZG.js").then((e) => e.n), "AssetCatalog")],
	["object_view", L(() => import("./ObjectView-FLpkSe3i.js").then((e) => e.n), "ObjectView")],
	["code_browser", L(() => import("./CodeBrowser-BUVLjsWa.js").then((e) => e.n), "CodeBrowser")],
	["record_grid", L(() => import("./RecordGrid-tjrGtFDR.js").then((e) => e.n), "RecordGrid")],
	["record_board", L(() => import("./RecordBoard-BtDEHvHZ.js").then((e) => e.n), "RecordBoard")],
	["record_calendar", L(() => import("./RecordCalendar-CH-Q_ykX.js").then((e) => e.n), "RecordCalendar")],
	["record_form", L(() => import("./RecordForm--Eur_kDg.js").then((e) => e.n), "RecordForm")],
	["action_form", L(() => import("./ActionForm-BXZS8xXh.js").then((e) => e.n), "ActionForm")],
	["orderbook", L(() => import("./OrderBook-XdEesLmI.js").then((e) => e.n), "OrderBook")],
	["depth_chart", L(() => import("./DepthChart-gNxepP0x.js").then((e) => e.n), "DepthChart")],
	["paired_grid", L(() => import("./PairedGrid-DvUui-uR.js").then((e) => e.n), "PairedGrid")],
	["trade", L(() => import("./Trade-CUZiT94O.js").then((e) => e.n), "Trade")],
	["ticker", L(() => import("./Ticker-DRCT2HBL.js").then((e) => e.n), "Ticker")],
	["volume_profile", L(() => import("./VolumeProfile-CMBdj7FN.js").then((e) => e.n), "VolumeProfile")],
	["stat_strip", L(() => import("./StatStrip-grhdVPic.js").then((e) => e.n), "StatStrip")],
	["bar_chart", L(() => import("./BarChart-CgGJSxnD.js").then((e) => e.n), "BarChart")],
	["scatter", L(() => import("./Scatter-B_sSCVfX.js").then((e) => e.n), "Scatter")],
	["clock", L(() => import("./Clock-Cc9ABoWJ.js").then((e) => e.n), "Clock")],
	["treemap", L(() => import("./Treemap-BUYBUQcL.js").then((e) => e.n), "Treemap")],
	["image", L(() => import("./Image-TVBY27Mv.js").then((e) => e.n), "Image")],
	["iframe", L(() => import("./Iframe-B_h9l6Nw.js").then((e) => e.n), "Iframe")],
	["histogram", L(() => import("./Histogram-C1-R4opU.js").then((e) => e.n), "Histogram")],
	["section", L(() => import("./Section-Cpjr_7EV.js").then((e) => e.n), "Section")],
	["area_chart", L(() => import("./AreaChart-BCUxtNj1.js").then((e) => e.n), "AreaChart")],
	["slider", L(() => import("./Slider-9NsItA39.js").then((e) => e.n), "Slider")],
	["select", L(() => import("./Select-Dj7u5tw4.js").then((e) => e.n), "Select")],
	["boxplot", L(() => import("./Boxplot-Be67M0Xp.js").then((e) => e.n), "Boxplot")],
	["radar", L(() => import("./Radar-C4sR-5ja.js").then((e) => e.n), "Radar")],
	["dag", L(() => import("./Dag-DIPZ7FVb.js").then((e) => e.n), "Dag")],
	["geo_map", L(() => import("./GeoMap-DCmdmF-a.js").then((e) => e.n), "GeoMap")],
	["media_gallery", L(() => import("./MediaGalleryImpl-DNwYXBnE.js"), "MediaGalleryImpl")],
	["multi_select", L(() => import("./MultiSelect-DRiu2Vy3.js").then((e) => e.n), "MultiSelect")],
	["json", L(() => import("./Json-BOKJr9mK.js").then((e) => e.n), "Json")],
	["sparkline", L(() => import("./Sparkline-BcaMfy7S.js").then((e) => e.n), "Sparkline")],
	["action_log", L(() => import("./ActionLog-C_wbqUk7.js").then((e) => e.n), "ActionLog")],
	["alert_log", L(() => import("./AlertLog-Ddj9J8is.js").then((e) => e.n), "AlertLog")],
	["tape", L(() => import("./Tape-Bo2QkTzd.js").then((e) => e.n), "Tape")],
	["file_browser", L(() => import("./FileBrowser-FWnjEtBG.js").then((e) => e.n), "FileBrowser")]
...
async function Hn(e) {
	let { parquetWriteBuffer: t } = await import("./src-5pr7F14U.js"), n = t({ columnData: e.columns.length > 0 ? Vn(e) : [{
		name: "value",
		data: []
	}] });
