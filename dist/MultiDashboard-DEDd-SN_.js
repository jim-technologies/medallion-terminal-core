import { d as e, n as t, t as n, u as r } from "./States-Bv4BL8dX.js";
import { c as i, t as a } from "./AssetOpen-CjGLA-3L.js";
import { o } from "./basemaps-BjEaZSH5.js";
...
var L = (e, t) => l(() => e().then((e) => ({ default: e[t] }))), ue = /* @__PURE__ */ new Map([
	["timeseries", L(() => import("./Timeseries-DILTJI5O.js").then((e) => e.n), "Timeseries")],
	["candlestick", L(() => import("./Candlestick-Bq0fFrmi.js").then((e) => e.n), "Candlestick")],
	["table", L(() => import("./DataTable-fEILUw7V.js").then((e) => e.n), "DataTable")],
	["metric", L(() => import("./Metric-CsN3_xvB.js").then((e) => e.n), "Metric")],
	["text", L(() => import("./Text-Bd9lTCgf.js").then((e) => e.n), "Text")],
	["conversation", L(() => import("./ConversationImpl-LGY7zq9z.js"), "ConversationImpl")],
	["prompt", L(() => import("./Prompt-gRbYVqDf.js").then((e) => e.n), "Prompt")],
	["gauge", L(() => import("./Gauge-B6x5XjmI.js").then((e) => e.n), "Gauge")],
	["distribution", L(() => import("./Distribution-C3w4_OnG.js").then((e) => e.n), "Distribution")],
	["heatmap", L(() => import("./Heatmap-Bo-qSPUx.js").then((e) => e.n), "Heatmap")],
	["events", L(() => import("./Events-DS017_nb.js").then((e) => e.n), "Events")],
	["catalog", L(() => import("./Catalog-BlT4iGb5.js").then((e) => e.n), "Catalog")],
	["asset_catalog", L(() => import("./AssetCatalog-CZCyOgtA.js").then((e) => e.n), "AssetCatalog")],
	["object_view", L(() => import("./ObjectView-BeyB5ycm.js").then((e) => e.n), "ObjectView")],
	["code_browser", L(() => import("./CodeBrowser-CPopGBad.js").then((e) => e.n), "CodeBrowser")],
	["record_grid", L(() => import("./RecordGrid-Dhg_lin3.js").then((e) => e.n), "RecordGrid")],
	["record_board", L(() => import("./RecordBoard-Ddjd5o2G.js").then((e) => e.n), "RecordBoard")],
	["record_calendar", L(() => import("./RecordCalendar-B61qHh0l.js").then((e) => e.n), "RecordCalendar")],
	["record_form", L(() => import("./RecordForm-MBizRyFA.js").then((e) => e.n), "RecordForm")],
	["action_form", L(() => import("./ActionForm-CVmBSITR.js").then((e) => e.n), "ActionForm")],
	["orderbook", L(() => import("./OrderBook-JCoxcP1n.js").then((e) => e.n), "OrderBook")],
	["depth_chart", L(() => import("./DepthChart-Bt3UIGYT.js").then((e) => e.n), "DepthChart")],
	["paired_grid", L(() => import("./PairedGrid-DBTQ-rHp.js").then((e) => e.n), "PairedGrid")],
	["trade", L(() => import("./Trade-6p4W0hGE.js").then((e) => e.n), "Trade")],
	["ticker", L(() => import("./Ticker-B3uk6XlG.js").then((e) => e.n), "Ticker")],
	["volume_profile", L(() => import("./VolumeProfile-DZWDk4hC.js").then((e) => e.n), "VolumeProfile")],
	["stat_strip", L(() => import("./StatStrip-D3CpqhCR.js").then((e) => e.n), "StatStrip")],
	["bar_chart", L(() => import("./BarChart-wvmdE-cm.js").then((e) => e.n), "BarChart")],
	["scatter", L(() => import("./Scatter-BGHjhmNu.js").then((e) => e.n), "Scatter")],
	["clock", L(() => import("./Clock-Cc9ABoWJ.js").then((e) => e.n), "Clock")],
	["treemap", L(() => import("./Treemap-Cj1Q0msd.js").then((e) => e.n), "Treemap")],
	["image", L(() => import("./Image-NVZkjvol.js").then((e) => e.n), "Image")],
	["iframe", L(() => import("./Iframe-CF6EFgZZ.js").then((e) => e.n), "Iframe")],
	["histogram", L(() => import("./Histogram-NZJbePTJ.js").then((e) => e.n), "Histogram")],
	["section", L(() => import("./Section-Cpjr_7EV.js").then((e) => e.n), "Section")],
	["area_chart", L(() => import("./AreaChart-DCs0ofEK.js").then((e) => e.n), "AreaChart")],
	["slider", L(() => import("./Slider-B1L65C6l.js").then((e) => e.n), "Slider")],
	["select", L(() => import("./Select-D1nHVTDZ.js").then((e) => e.n), "Select")],
	["boxplot", L(() => import("./Boxplot-B3z0J3zA.js").then((e) => e.n), "Boxplot")],
	["radar", L(() => import("./Radar-BzeNi7Fd.js").then((e) => e.n), "Radar")],
	["dag", L(() => import("./Dag-BrQBIsMa.js").then((e) => e.n), "Dag")],
	["geo_map", L(() => import("./GeoMap-C6BkPIXm.js").then((e) => e.n), "GeoMap")],
	["media_gallery", L(() => import("./MediaGalleryImpl-BOyjPmCb.js"), "MediaGalleryImpl")],
	["multi_select", L(() => import("./MultiSelect-C6XDdzUb.js").then((e) => e.n), "MultiSelect")],
	["json", L(() => import("./Json-DP7t7nxb.js").then((e) => e.n), "Json")],
	["sparkline", L(() => import("./Sparkline-BPDmmt6i.js").then((e) => e.n), "Sparkline")],
	["action_log", L(() => import("./ActionLog-Fr_FA-hJ.js").then((e) => e.n), "ActionLog")],
	["alert_log", L(() => import("./AlertLog-BG2QOo64.js").then((e) => e.n), "AlertLog")],
	["tape", L(() => import("./Tape-bD1xHQhA.js").then((e) => e.n), "Tape")],
	["file_browser", L(() => import("./FileBrowser-BSPz4QLo.js").then((e) => e.n), "FileBrowser")]
			...
			children: [/* @__PURE__ */ _("h2", {
				...
				children: [
					re && D && /* @__PURE__ */ v("span", {
						className: `text-[11px] ${P ? "text-amber-400/80" : "text-zinc-600"}`,
...
function yi({ template: t, backendUrl: n, backendHeaders: i = vi, onEvent: o, onIntent: s, onCtxChange: c, paletteSuggest: l, chrome: d = "full", onShare: y, theme: x, templateTrust: S = "untrusted", templateTrustPolicy: C = $, resolveAssetIntent: w, assetRenderers: T, assetApplicationFrame: ee, saveAssetOpenPreference: E, onAssetOpenError: D, registry: O }) {
	let k = e(), A = x ?? k?.theme ?? "dark", te = b(), ne = t.columns || 12, [j, re] = h(t.widgets), M = O ? [...O.keys()].sort().join("\0") : "", N = p(() => Er(t, O?.keys(), { includeBuiltIns: O == null }), [
		t,
		O,
		M
...
function Di({ tabs: t, activeIndex: n, onSelect: i, backendUrl: a, backendHeaders: o, theme: s, templateTrust: c, templateTrustPolicy: l, resolveAssetIntent: u, assetRenderers: d, assetApplicationFrame: p, saveAssetOpenPreference: m, onAssetOpenError: g, onIntent: y, registry: b }) {
	let x = e(), S = s ?? x?.theme ?? "dark", C = Math.max(0, Math.min(n, t.length - 1));
	Ei(t.length, i);
