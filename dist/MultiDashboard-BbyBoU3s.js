...
var z = (e, t) => h(() => e().then((e) => ({ default: e[t] }))), B = /* @__PURE__ */ new Map([
	["timeseries", z(() => import("./Timeseries-DISvxBd_.js").then((e) => e.n), "Timeseries")],
	["candlestick", z(() => import("./Candlestick-UFMd_Krl.js").then((e) => e.n), "Candlestick")],
	["table", z(() => import("./DataTable-D65rFAYm.js").then((e) => e.n), "DataTable")],
	["metric", z(() => import("./Metric-CsN3_xvB.js").then((e) => e.n), "Metric")],
	["text", z(() => import("./Text-DET9_PdK.js").then((e) => e.n), "Text")],
	["conversation", z(() => import("./ConversationImpl-CPk8GFA3.js"), "ConversationImpl")],
	["prompt", z(() => import("./Prompt-YlcyOjzq.js").then((e) => e.n), "Prompt")],
	["gauge", z(() => import("./Gauge-BKPZPc3w.js").then((e) => e.n), "Gauge")],
	["distribution", z(() => import("./Distribution-VTaDDntZ.js").then((e) => e.n), "Distribution")],
	["heatmap", z(() => import("./Heatmap-CjXmoteA.js").then((e) => e.n), "Heatmap")],
	["events", z(() => import("./Events-C2yJtKoE.js").then((e) => e.n), "Events")],
	["catalog", z(() => import("./Catalog-BiHcykAf.js").then((e) => e.n), "Catalog")],
	["asset_catalog", z(() => import("./AssetCatalog-CuRPcNhH.js").then((e) => e.n), "AssetCatalog")],
	["object_view", z(() => import("./ObjectView-BHhlKxCT.js").then((e) => e.n), "ObjectView")],
	["code_browser", z(() => import("./CodeBrowser-DorjybFk.js").then((e) => e.n), "CodeBrowser")],
	["record_grid", z(() => import("./RecordGrid-DqwQI_u5.js").then((e) => e.n), "RecordGrid")],
	["record_board", z(() => import("./RecordBoard-DDd7DKLZ.js").then((e) => e.n), "RecordBoard")],
	["record_calendar", z(() => import("./RecordCalendar-Dll7lz1H.js").then((e) => e.n), "RecordCalendar")],
	["record_form", z(() => import("./RecordForm-DYzywvE0.js").then((e) => e.n), "RecordForm")],
	["action_form", z(() => import("./ActionForm-7y7_q9qy.js").then((e) => e.n), "ActionForm")],
	["orderbook", z(() => import("./OrderBook-BhIazgTt.js").then((e) => e.n), "OrderBook")],
	["depth_chart", z(() => import("./DepthChart-BMVh7dxM.js").then((e) => e.n), "DepthChart")],
	["paired_grid", z(() => import("./PairedGrid-CRiwFlm6.js").then((e) => e.n), "PairedGrid")],
	["trade", z(() => import("./Trade-DrM-NtDE.js").then((e) => e.n), "Trade")],
	["ticker", z(() => import("./Ticker-DPCB9kvb.js").then((e) => e.n), "Ticker")],
	["volume_profile", z(() => import("./VolumeProfile-Bz8y56oy.js").then((e) => e.n), "VolumeProfile")],
	["stat_strip", z(() => import("./StatStrip-Cfs2aUzj.js").then((e) => e.n), "StatStrip")],
	["bar_chart", z(() => import("./BarChart-CeRNP7v6.js").then((e) => e.n), "BarChart")],
	["scatter", z(() => import("./Scatter-BchEPkj8.js").then((e) => e.n), "Scatter")],
	["clock", z(() => import("./Clock-Cc9ABoWJ.js").then((e) => e.n), "Clock")],
	["treemap", z(() => import("./Treemap-BWsCjZ5W.js").then((e) => e.n), "Treemap")],
	["image", z(() => import("./Image-ChH1RQKA.js").then((e) => e.n), "Image")],
	["iframe", z(() => import("./Iframe-BCOwaLRd.js").then((e) => e.n), "Iframe")],
	["histogram", z(() => import("./Histogram-75cLYgox.js").then((e) => e.n), "Histogram")],
	["section", z(() => import("./Section-Cpjr_7EV.js").then((e) => e.n), "Section")],
	["area_chart", z(() => import("./AreaChart-CqAdCo4G.js").then((e) => e.n), "AreaChart")],
	["slider", z(() => import("./Slider-Bvxtigib.js").then((e) => e.n), "Slider")],
	["select", z(() => import("./Select-D7GX4Bx2.js").then((e) => e.n), "Select")],
	["boxplot", z(() => import("./Boxplot-CP4vpeLI.js").then((e) => e.n), "Boxplot")],
	["radar", z(() => import("./Radar-Bj-B-F79.js").then((e) => e.n), "Radar")],
	["dag", z(() => import("./Dag-DuVLLCV2.js").then((e) => e.n), "Dag")],
	["geo_map", z(() => import("./GeoMap-CUEm2YYF.js").then((e) => e.n), "GeoMap")],
	["media_gallery", z(() => import("./MediaGalleryImpl-Cvi6bA6g.js"), "MediaGalleryImpl")],
	["multi_select", z(() => import("./MultiSelect-D178a-r5.js").then((e) => e.n), "MultiSelect")],
	["json", z(() => import("./Json-COYFQFVR.js").then((e) => e.n), "Json")],
	["sparkline", z(() => import("./Sparkline-HiV7GoAv.js").then((e) => e.n), "Sparkline")],
	["action_log", z(() => import("./ActionLog-DBocP3oo.js").then((e) => e.n), "ActionLog")],
	["alert_log", z(() => import("./AlertLog-DFYhMsWS.js").then((e) => e.n), "AlertLog")],
	["tape", z(() => import("./Tape-DkJamusC.js").then((e) => e.n), "Tape")],
	["file_browser", z(() => import("./FileBrowser-C8SAsBhF.js").then((e) => e.n), "FileBrowser")]
