...
function u({ options: e }) {
	let c = e ?? {}, { ctx: u, setCtx: f } = t(), p = c.min ?? 0, m = c.max ?? 100, h = c.step ?? 1, g = c.label ?? c.key ?? "value", _ = (() => {
	...
	if (r(() => {
		...
		if (e == null) return;
		let t = Number(e);
		Number.isFinite(t) && t !== v && y(t);
	}, [c.key, u[c.key ?? ""]]), !c.key) return /* @__PURE__ */ o(n, { children: "Slider requires options.key" });
	let x = (e) => {
		y(e), b.current && clearTimeout(b.current), b.current = setTimeout(() => {
			f(c.key, String(e));
		}, l);
	};
		...
		children: [
			/* @__PURE__ */ s("div", {
				...
				children: [/* @__PURE__ */ o("span", {
					...
					children: [d(v, h), c.unit && /* @__PURE__ */ o("span", {
