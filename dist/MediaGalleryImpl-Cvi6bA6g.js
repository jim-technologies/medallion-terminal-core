import { i as e, n as t } from "./utils-j4lJ7S1v.js";
import { At as n, It as r, J as i, X as a, Y as o, Z as s, q as c } from "./MultiDashboard-BbyBoU3s.js";
import { s as l } from "./AssetOpen-CjGLA-3L.js";
import { n as u, t as d } from "./CursorPager-BOAhVeeB.js";
		...
		children: [
			...
			/* @__PURE__ */ v("div", {
				...
				children: /* @__PURE__ */ v("div", {
					className: "text-[11px] font-medium text-[var(--mtc-on-scrim)] truncate",
					children: e.title
				})
			}),
			/* @__PURE__ */ v("div", {
				...
				children: e.kind === "video" && /* @__PURE__ */ y("span", {
					className: "px-1.5 py-0.5 rounded-sm bg-black/70 text-[9px] uppercase tracking-wider text-[var(--mtc-on-scrim)]",
					children: ["▶", r ? ` ${r}` : ""]
				})
			}),
...
function S({ item: e }) {
	...
	return !r || t ? /* @__PURE__ */ v("div", {
		className: "absolute inset-0 flex items-center justify-center bg-[var(--mtc-panel)]",
