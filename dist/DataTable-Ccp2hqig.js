...
import { At as t, It as n } from "./MultiDashboard-794VPNli.js";
				...
				children: /* @__PURE__ */ m("table", {
					...
					children: [/* @__PURE__ */ p("thead", {
						...
						children: /* @__PURE__ */ p("tr", { children: D.map((e) => {
							let t = j[e], n = t && t !== "sparkline" && /^(currency|percent|bps|compact)(:|$)/.test(t);
							return /* @__PURE__ */ m("th", {
								onClick: () => Q(e),
								className: `px-3 py-2 text-zinc-400 border-b border-zinc-700 cursor-pointer hover:text-zinc-100 select-none whitespace-nowrap font-medium ${n ? "text-right" : "text-left"}`,
						...
						return /* @__PURE__ */ p("tr", {
							...
							children: D.map((t) => {
								...
								let o = a ? w(r, a) : C(r), s = a ? a.split(":").slice(1).includes("signed") : !1, l = a && a !== "sparkline" && /^(currency|percent|bps|compact)(:|$)/.test(a) ? "text-right" : "";
								return /* @__PURE__ */ p("td", {
									className: `px-3 py-2.5 whitespace-nowrap tabular-nums ${l} ${s && typeof r == "number" ? r > 0 ? "text-emerald-400" : r < 0 ? "text-red-400" : "text-zinc-100" : "text-zinc-100"}`,
									style: i,
									children: o
								}, t);
							})
...
function w(e, t) {
	...
	switch (n) {
		case "currency": {
			let t = c.find((e) => e !== "signed") ?? "USD";
			return i(e, t);
		}
		case "percent": {
			let t = l.has("p") ? "percent" : "fraction";
			return o(e, {
				signed: u,
				as: t
			});
