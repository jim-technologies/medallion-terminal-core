import { Vt as e } from "./MultiDashboard-794VPNli.js";
...
function S(e, t) {
	...
	else typeof window < "u" && (n = window.location.origin);
	if (!n) return !1;
	try {
		return new URL(t, n).origin === n;
	} catch {
		return !1;
	}
}
...
function w(e, t, n) {
	return n && S(e, t) ? n : globalThis.fetch;
}
function T(e) {
...
//#endregion
export { E as _, r as a, c as b, v as c, h as d, i as f, _ as g, g as h, t as i, l, p as m, C as n, u as o, D as p, b as r, n as s, T as t, m as u, x as v, w as x, o as y };
