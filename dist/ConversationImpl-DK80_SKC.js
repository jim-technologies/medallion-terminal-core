import { At as e, It as t } from "./MultiDashboard-B8rxYV_S.js";
import { r as n, t as r } from "./textNormalize-Ba1I6dwH.js";
import { n as i, t as a } from "./CursorPager-oL9LIbPr.js";
...
function w({ data: n, options: r, widgetId: c }) {
	let { ctx: d } = e(), f = o(() => S(n), [n]), p = r ?? {}, m = p.mode ?? "channel", h = !!f.nextPageToken || !!d[i(c, p)], [g, _] = s(""), v = o(() => {
	...
	return /* @__PURE__ */ u("div", {
		...
		children: [
			...
			/* @__PURE__ */ l("div", {
				...
				children: f.messages.length === 0 ? /* @__PURE__ */ l(t, { children: "No messages" }) : v.length === 0 ? /* @__PURE__ */ l(t, { children: "No matching messages" }) : v.map((e, t) => /* @__PURE__ */ l(E, {
					conversation: f,
					message: e,
					previous: v[t - 1],
					mode: m,
...
function T({ conversation: t, showParticipants: n }) {
	let { setCtx: r } = e();
	return /* @__PURE__ */ u("button", {
		type: "button",
		onClick: () => {
			for (let [e, n] of Object.entries(t.context)) r(e, n);
			t.id && !("conversation_id" in t.context) && r("conversation_id", t.id);
		},
		className: "mb-2 flex w-full items-start justify-between gap-3 border-b border-zinc-800 px-1 pb-2 text-left",
		children: [/* @__PURE__ */ u("span", {
			className: "min-w-0",
			children: [t.title && /* @__PURE__ */ l("strong", {
				className: "block truncate text-sm font-medium text-zinc-100",
				children: t.title
			}), t.subtitle && /* @__PURE__ */ l("span", {
				className: "block truncate text-[11px] text-zinc-500",
				children: t.subtitle
			})]
		}), /* @__PURE__ */ u("span", {
			className: "flex shrink-0 items-center gap-2",
			children: [t.unreadCount != null && t.unreadCount > 0 && /* @__PURE__ */ u("span", {
				className: "rounded-full bg-sky-500/15 px-1.5 py-0.5 text-[9px] font-medium text-sky-300",
				children: [t.unreadCount, " unread"]
			}), n && t.participants.length > 0 && /* @__PURE__ */ l("span", {
				className: "flex -space-x-1",
				"aria-label": `${t.participants.length} participants`,
				children: t.participants.slice(0, 4).map((e) => /* @__PURE__ */ l(k, {
					participant: e,
					size: "small"
				}, e.id))
			})]
...
function E({ conversation: t, message: n, previous: r, mode: i, options: a }) {
	let { ctx: o, setCtx: s } = e(), c = {
	...
	}, d = o[c.messageKey ?? "message_id"] === n.id, f = n.senderId ? t.participants.find((e) => e.id === n.senderId) : void 0, p = !!t.viewerId && n.senderId === t.viewerId, m = i === "channel" && r?.senderId != null && r.senderId === n.senderId && r.kind === n.kind, h = n.replyToId ? t.messages.find((e) => e.id === n.replyToId) : void 0, g = () => {
		for (let [e, r] of Object.entries(C(t, n, c))) s(e, r);
	}, _ = (e) => {
