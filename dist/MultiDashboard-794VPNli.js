...
var z = (e, t) => h(() => e().then((e) => ({ default: e[t] }))), B = /* @__PURE__ */ new Map([
	["timeseries", z(() => import("./Timeseries-DZPf2Ii2.js").then((e) => e.n), "Timeseries")],
	["candlestick", z(() => import("./Candlestick-C03eM9SN.js").then((e) => e.n), "Candlestick")],
	["table", z(() => import("./DataTable-Ccp2hqig.js").then((e) => e.n), "DataTable")],
	["metric", z(() => import("./Metric-CsN3_xvB.js").then((e) => e.n), "Metric")],
	["text", z(() => import("./Text-uSLLznZf.js").then((e) => e.n), "Text")],
	["conversation", z(() => import("./ConversationImpl-BZsEXjt4.js"), "ConversationImpl")],
	["prompt", z(() => import("./Prompt-BHEG0pvm.js").then((e) => e.n), "Prompt")],
	["gauge", z(() => import("./Gauge-CY3mZY8M.js").then((e) => e.n), "Gauge")],
	["distribution", z(() => import("./Distribution-BK5sj48q.js").then((e) => e.n), "Distribution")],
	["heatmap", z(() => import("./Heatmap-b0vmtWQo.js").then((e) => e.n), "Heatmap")],
	["events", z(() => import("./Events-CFb6gzR7.js").then((e) => e.n), "Events")],
	["catalog", z(() => import("./Catalog-DTOci4c4.js").then((e) => e.n), "Catalog")],
	["asset_catalog", z(() => import("./AssetCatalog-Ca9F6_B8.js").then((e) => e.n), "AssetCatalog")],
	["object_view", z(() => import("./ObjectView-BKeGDIqw.js").then((e) => e.n), "ObjectView")],
	["code_browser", z(() => import("./CodeBrowser-CAIHRYjY.js").then((e) => e.n), "CodeBrowser")],
	["record_grid", z(() => import("./RecordGrid-DTXfYz4X.js").then((e) => e.n), "RecordGrid")],
	["record_board", z(() => import("./RecordBoard-BgL1kWoZ.js").then((e) => e.n), "RecordBoard")],
	["record_calendar", z(() => import("./RecordCalendar-BbQjB-oL.js").then((e) => e.n), "RecordCalendar")],
	["record_form", z(() => import("./RecordForm-UxuEa-Ey.js").then((e) => e.n), "RecordForm")],
	["action_form", z(() => import("./ActionForm-tHswJFR8.js").then((e) => e.n), "ActionForm")],
	["orderbook", z(() => import("./OrderBook-CQzvqsv-.js").then((e) => e.n), "OrderBook")],
	["depth_chart", z(() => import("./DepthChart-XaVVWneE.js").then((e) => e.n), "DepthChart")],
	["paired_grid", z(() => import("./PairedGrid-C61lVxO6.js").then((e) => e.n), "PairedGrid")],
	["trade", z(() => import("./Trade-BOxJOBnW.js").then((e) => e.n), "Trade")],
	["ticker", z(() => import("./Ticker-CbHG3S88.js").then((e) => e.n), "Ticker")],
	["volume_profile", z(() => import("./VolumeProfile-zSufzJO8.js").then((e) => e.n), "VolumeProfile")],
	["stat_strip", z(() => import("./StatStrip-kkO5BkyW.js").then((e) => e.n), "StatStrip")],
	["bar_chart", z(() => import("./BarChart-CjN9iEI_.js").then((e) => e.n), "BarChart")],
	["scatter", z(() => import("./Scatter-ByRRITF6.js").then((e) => e.n), "Scatter")],
	["clock", z(() => import("./Clock-Cc9ABoWJ.js").then((e) => e.n), "Clock")],
	["treemap", z(() => import("./Treemap-Bm44fruQ.js").then((e) => e.n), "Treemap")],
	["image", z(() => import("./Image-gV9xe1P5.js").then((e) => e.n), "Image")],
	["iframe", z(() => import("./Iframe-CX27vx-7.js").then((e) => e.n), "Iframe")],
	["histogram", z(() => import("./Histogram-CHcIdPV4.js").then((e) => e.n), "Histogram")],
	["section", z(() => import("./Section-Cpjr_7EV.js").then((e) => e.n), "Section")],
	["area_chart", z(() => import("./AreaChart-Ch3JRu9Y.js").then((e) => e.n), "AreaChart")],
	["slider", z(() => import("./Slider-Brnng204.js").then((e) => e.n), "Slider")],
	["select", z(() => import("./Select-CaCM8qLh.js").then((e) => e.n), "Select")],
	["boxplot", z(() => import("./Boxplot-DKMDSkgx.js").then((e) => e.n), "Boxplot")],
	["radar", z(() => import("./Radar-C3RIeutH.js").then((e) => e.n), "Radar")],
	["dag", z(() => import("./Dag-B7j0Nkq3.js").then((e) => e.n), "Dag")],
	["geo_map", z(() => import("./GeoMap-C0Ih8yn3.js").then((e) => e.n), "GeoMap")],
	["media_gallery", z(() => import("./MediaGalleryImpl-Dane2BP-.js"), "MediaGalleryImpl")],
	["multi_select", z(() => import("./MultiSelect-BFM6h3it.js").then((e) => e.n), "MultiSelect")],
	["json", z(() => import("./Json-DmFRRXmm.js").then((e) => e.n), "Json")],
	["sparkline", z(() => import("./Sparkline-CCXWrhv4.js").then((e) => e.n), "Sparkline")],
	["action_log", z(() => import("./ActionLog-DQKIoP_-.js").then((e) => e.n), "ActionLog")],
	["alert_log", z(() => import("./AlertLog-C4mRMsZQ.js").then((e) => e.n), "AlertLog")],
	["tape", z(() => import("./Tape-h3iG6uk5.js").then((e) => e.n), "Tape")],
	["file_browser", z(() => import("./FileBrowser-Lgp7bhj_.js").then((e) => e.n), "FileBrowser")]
