...
function l({ theme: e, density: t, children: n }) {
	let r = i(() => ({
		theme: e,
		density: t
	}), [e, t]);
...
var u = n(function({ theme: e = "dark", density: t = "standard", className: n, children: r, ...i }, o) {
...
var p = {
	...
	search: `${d(11, 11, 6.5)}M16 16l4 4`,
	menu: "M4 7h16M4 12h16M4 17h16",
	"panel-left": `${f(3, 4, 18, 16)}M9 4v16`,
	"panel-right": `${f(3, 4, 18, 16)}M15 4v16`,
	"external-link": "M14 5h5v5m-9 4 9-9m0 8v6H5V5h6",
	settings: `${d(12, 12, 3)}M19.4 15a1.7 1.7 0 0 0 .3 1.9l.1.1-2.8 2.8-.1-.1a1.7 1.7 0 0 0-1.9-.3 1.7 1.7 0 0 0-1 1.6v.2h-4V21a1.7 1.7 0 0 0-1-1.6 1.7 1.7 0 0 0-1.9.3l-.1.1L4.2 17l.1-.1a1.7 1.7 0 0 0 .3-1.9A1.7 1.7 0 0 0 3 14H2.8v-4H3a1.7 1.7 0 0 0 1.6-1 1.7 1.7 0 0 0-.3-1.9L4.2 7 7 4.2l.1.1A1.7 1.7 0 0 0 9 4.6 1.7 1.7 0 0 0 10 3V2.8h4V3a1.7 1.7 0 0 0 1 1.6 1.7 1.7 0 0 0 1.9-.3l.1-.1L19.8 7l-.1.1a1.7 1.7 0 0 0-.3 1.9 1.7 1.7 0 0 0 1.6 1h.2v4H21a1.7 1.7 0 0 0-1.6 1Z`,
	spinner: "M12 3a9 9 0 1 0 9 9M21 3v6h-6",
	copy: `${f(8, 8, 12, 12)}M16 8V5a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h3`,
	filter: "M4 5h16l-6 7.5V19l-4 2v-8.5z",
	columns: `${f(3, 4, 18, 16)}M9 4v16M15 4v16`,
	...
	eye: `M2.5 12S6 5 12 5s9.5 7 9.5 7-3.5 7-9.5 7-9.5-7-9.5-7z${d(12, 12, 3)}`,
	...
	terminal: `${f(3, 4, 18, 16)}M7 9l3 3-3 3M12 15h5`,
	plug: "M9 3v5m6-5v5M6 8h12v3a6 6 0 0 1-12 0zm6 9v4",
	info: `${d(12, 12, 9)}M12 11v5M12 8h.01`,
	warning: "M10.3 3.9 2.6 17.2A2 2 0 0 0 4.3 20h15.4a2 2 0 0 0 1.7-2.8L13.7 3.9a2 2 0 0 0-3.4 0ZM12 9v4m0 4h.01",
	error: `${d(12, 12, 9)}M9 9l6 6M15 9l-6 6`,
	home: "M4 11 12 4l8 7v9a1 1 0 0 1-1 1h-4v-6H9v6H5a1 1 0 0 1-1-1z",
	explore: `${d(12, 12, 9)}M15.5 8.5l-2 5-5 2 2-5z`,
	ontology: `${d(6, 7, 2.5)}${f(15, 4.5, 5, 5, 1)}M12 14l3.5 6h-7zM8.5 7h6.5M7.4 9.1l3.2 5M16.6 9.6 13.5 14`,
	topology: `${d(12, 5, 2)}${d(12, 13, 2)}${d(5, 19, 2)}${d(19, 19, 2)}M12 7v4m-1.6 3.2-3.8 3.4m7-3.4 3.8 3.4`,
	activity: "M3 12h4l3-8 4 16 3-8h4",
	object: `M12 3l8 4.5v9L12 21l-8-4.5v-9z${d(12, 12, 2.5)}`,
	person: `${d(12, 8, 3.5)}M5 20a7 7 0 0 1 14 0`,
	people: `${d(9, 8.5, 3)}M3.5 19a5.5 5.5 0 0 1 11 0${d(16.5, 9.5, 2.5)}M15.8 14.1A4.5 4.5 0 0 1 20.5 19`,
	organization: `${f(9, 3, 6, 5, 1)}${f(3, 16, 6, 5, 1)}${f(15, 16, 6, 5, 1)}M12 8v4M6 16v-4h12v4`,
	...
	table: `${f(3, 4, 18, 16)}M3 9h18M3 14.5h18M9 9v11`,
	column: `${f(3, 4, 18, 16)}M3 9h18M10 4v16M14 4v16`,
	bucket: "M4 6h16l-1.8 13.2a1 1 0 0 1-1 .8H6.8a1 1 0 0 1-1-.8zM4 6c0-1.1 3.6-2 8-2s8 .9 8 2",
	link: "M10 14a4 4 0 0 0 5.7 0l3-3a4 4 0 0 0-5.7-5.7l-1 1M14 10a4 4 0 0 0-5.7 0l-3 3a4 4 0 0 0 5.7 5.7l1-1",
	graph: `${d(6, 6, 2)}${d(18, 8, 2)}${d(9, 18, 2)}M8 6.3l8 1.4M6.5 8l2 8M16.8 9.6l-6.6 6.8`,
	event: `${f(3, 5, 18, 16)}M3 10h18M8 3v4m8-4v4M11 14h2v2h-2z`,
	calendar: `${f(3, 5, 18, 16)}M3 10h18M8 3v4m8-4v4`,
	clock: `${d(12, 12, 9)}M12 7v5l3 2`,
	currency: `${d(12, 12, 9)}M14.5 9.5C14 8.5 13.1 8 12 8c-1.5 0-2.5.8-2.5 2s1 1.7 2.5 2 2.5.8 2.5 2-1 2-2.5 2c-1.1 0-2-.5-2.5-1.5M12 6.5V8m0 8v1.5`,
	order: "M6 3h12v18l-3-2-3 2-3-2-3 2zM9 8h6m-6 4h6m-6 4h3",
	package: "M12 3 4 7v10l8 4 8-4V7zM4 7l8 4 8-4m-8 4v10",
	truck: `M3 6h11v10H3zm11 4h4l3 3v3h-7z${d(7, 18, 2)}${d(17, 18, 2)}`,
	location: `M12 21s-7-6.2-7-11.5a7 7 0 0 1 14 0C19 14.8 12 21 12 21z${d(12, 9.5, 2.5)}`,
	tag: `M3 12V4a1 1 0 0 1 1-1h8l9 9-9 9z${d(7.5, 7.5, 1.5)}`,
	...
	key: `${d(8, 15, 4)}M11 12l8-8M16 7l2 2M14 9l2 2`,
	lock: `${f(5, 11, 14, 10)}M8 11V8a4 4 0 0 1 8 0v3`,
	server: `${f(4, 4, 16, 7)}${f(4, 13, 16, 7)}M8 7.5h.01M8 16.5h.01`,
	cloud: "M7 19a4 4 0 0 1-.7-7.9 6 6 0 0 1 11.5-1.6A4.5 4.5 0 0 1 17.5 19z",
	branch: `${d(6, 5, 2)}${d(6, 19, 2)}${d(18, 7, 2)}M6 7v10m12-8v1a4 4 0 0 1-4 4H8a2 2 0 0 0-2 2`,
	commit: `${d(12, 12, 3.5)}M3 12h5.5m7 0H21`,
	workflow: `${f(3, 3, 6, 6, 1)}${f(15, 15, 6, 6, 1)}M9 6h4a4 4 0 0 1 4 4v5m-2.5-2.5L17 15l2.5-2.5`,
	play: "M8 5v14l11-7z",
	pause: "M8 5v14M16 5v14",
	film: `${f(3, 4, 18, 16)}M7 4v16M17 4v16M3 9h4m-4 6h4m10-6h4m-4 6h4`,
	music: `M9 18V5l11-2v13${d(6, 18, 3)}${d(17, 16, 3)}`,
	image: `${f(3, 4, 18, 16)}${d(8.5, 9.5, 1.5)}M21 16l-5-5-9 9`,
	"chart-line": "M4 4v16h16M7 15l4-4 3 3 5-6",
	"chart-bar": "M4 4v16h16M8 16v-4m4 4V8m4 8v-6",
	globe: `${d(12, 12, 9)}M3 12h18M12 3c2.5 2.5 3.8 5.5 3.8 9s-1.3 6.5-3.8 9c-2.5-2.5-3.8-5.5-3.8-9S9.5 5.5 12 3z`,
	mail: `${f(3, 5, 18, 14)}M3.5 6.5 12 13l8.5-6.5`,
	...
	badge: `${d(12, 9, 5)}M9 13.5 8 21l4-2 4 2-1-7.5`
}, m = [...Object.keys(p), "more"], h = n(function({ name: e, label: t, size: n = "1em", className: r, strokeWidth: i = 1.75, ...o }, s) {
	return /* @__PURE__ */ a("svg", {
		...
		focusable: "false",
		children: e === "more" ? /* @__PURE__ */ a("path", {
			d: `${d(5, 12, 1)}${d(12, 12, 1)}${d(19, 12, 1)}`,
			fill: "currentColor"
		}) : /* @__PURE__ */ a("path", { d: p[e] })
	});
}), g = n(function({ intent: t = "neutral", variant: n = "outline", size: r = "medium", density: i, loading: s = !1, loadingLabel: c = "Working", startIcon: l, endIcon: u, disabled: d, className: f, children: p, type: m = "button", ...g }, _) {
...
}), _ = n(function({ icon: t, className: n, loading: r = !1, loadingLabel: i = "Working", "aria-label": o, ...s }, c) {
	return /* @__PURE__ */ a(g, {
		...s,
		ref: c,
...
}), v = n(function({ label: t, density: n, className: r, children: i, ...o }, s) {
	return /* @__PURE__ */ a("div", {
		...o,
		ref: s,
		role: "group",
...
}), y = n(function({ title: t, description: n, icon: r, actions: i, compact: s, className: c, ...l }, u) {
...
}), b = n(function({ label: t = "Loading", description: n, variant: r = "spinner", lines: i = 3, compact: s, className: c, ...l }, u) {
	return /* @__PURE__ */ o("div", {
		...l,
		ref: u,
		role: "status",
		...
		"data-compact": s,
		children: [
			r === "spinner" ? /* @__PURE__ */ a(h, {
				name: "spinner",
				className: "mtc-state-spinner"
			}) : /* @__PURE__ */ a("div", {
				className: "mtc-state-skeleton",
				"aria-hidden": "true",
				children: Array.from({ length: x(i) }).map((e, t) => /* @__PURE__ */ a("span", { style: { width: `${88 - t * 9}%` } }, t))
			}),
			/* @__PURE__ */ a("div", {
				className: "mtc-state-title",
				children: t
...
var S = n(function({ title: t = "Unable to load", message: n, onRetry: r, retryLabel: i = "Retry", actions: s, compact: c, intent: l = "danger", className: u, ...d }, f) {
	return /* @__PURE__ */ o("div", {
		...d,
		ref: f,
		role: "alert",
		...
		children: [
			/* @__PURE__ */ a("div", {
				className: "mtc-state-icon",
				"aria-hidden": "true",
				children: /* @__PURE__ */ a(h, { name: l === "warning" ? "warning" : "error" })
			}),
			/* @__PURE__ */ a("div", {
				className: "mtc-state-title",
				children: t
...
//#endregion
export { v as a, h as c, c as d, g as i, u as l, S as n, _ as o, b as r, m as s, y as t, l as u };
