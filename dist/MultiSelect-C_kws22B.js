		...
		children: [/* @__PURE__ */ i("div", {
			...
			children: l.map((e) => {
				...
				return /* @__PURE__ */ r("button", {
					onClick: () => f(e.value),
					className: `px-2 py-0.5 text-xs rounded border ${t ? "bg-sky-500/20 border-sky-500/40 text-sky-200" : "bg-zinc-900 border-zinc-800 text-zinc-400 hover:text-zinc-200"}`,
					children: e.label
				}, e.value);
			})
		})]
