...
var l = 16384, u = /* @__PURE__ */ new WeakMap();
function d(e, t) {
	u.set(e, t);
}
...
async function p(t, n = {}) {
	let r, o, d = t.headers.get("content-type") ?? "";
	if (/\bjson\b/i.test(d)) try {
		let e = await f(t, l), n = JSON.parse(e);
	...
	return new e(o ?? `HTTP ${t.status}`, {
		...
		status: t.status,
		code: r,
		requestId: s(t.headers) ?? n.requestId ?? u.get(t),
		retryAfterMs: c(t.headers.get("retry-after"), n.now)
	});
}
function m(r) {
	if (t(r)) return r;
	let a = r instanceof Error ? r.cause : void 0;
	if (t(a)) return a;
	let o = r, c = typeof o?.code == "number" ? n[o.code] : typeof o?.code == "string" && n.includes(o.code) ? o.code : void 0, l = typeof o?.rawMessage == "string" && o.rawMessage ? o.rawMessage : r instanceof Error ? r.message : String(r);
	if (c && c !== "ok") {
		let t = o?.metadata instanceof Headers ? o.metadata : void 0;
		return new e(l, {
			kind: i(c),
			code: c,
	...
	return r instanceof Error && (r.name === "TimeoutError" || r.name === "TypeError") ? new e(l, { kind: "unavailable" }) : new e(l, { kind: "unknown" });
}
function h(e) {
	return e.code ? `${e.code}: ${e.message}` : e.message;
}
//#endregion
export { d as a, i as c, c as i, a as l, h as n, s as o, t as r, p as s, e as t, m as u };
