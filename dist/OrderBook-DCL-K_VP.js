...
import { At as t, H as n, It as r } from "./MultiDashboard-CwQKjnza.js";
			...
			/* @__PURE__ */ o("div", {
				...
				children: [
					/* @__PURE__ */ a("div", {
						...
						children: b.map((e, t) => /* @__PURE__ */ a(u, {
							side: "ask",
							level: e,
							cum: b.slice(t).reduce((e, t) => e + t.size, 0),
							maxSize: x,
							onPrice: m
						}, `ask-${t}`))
					}),
					...
					/* @__PURE__ */ a("div", {
						className: "flex-1 overflow-auto",
						children: y.map((e, t) => /* @__PURE__ */ a(u, {
							side: "bid",
							level: e,
							cum: y.slice(0, t + 1).reduce((e, t) => e + t.size, 0),
							maxSize: x,
							onPrice: m
						}, `bid-${t}`))
					})
