import { o as e, s as t } from "./States-D9k77DAQ.js";
...
var Y = s(function({ items: e, properties: t, density: n, emptyValue: r = "—", className: i, ...o }, s) {
	...
	return /* @__PURE__ */ h("dl", {
		...
		children: c.map((e, t) => /* @__PURE__ */ g("div", {
			...
			children: [/* @__PURE__ */ g("dt", { children: [/* @__PURE__ */ h("span", { children: e.label }), e.description && /* @__PURE__ */ h("small", { children: e.description })] }), /* @__PURE__ */ h("dd", { children: X(e.value, r) })]
		}, e.id ?? t))
	});
});
function X(e, t) {
