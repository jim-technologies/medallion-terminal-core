...
import { It as t } from "./MultiDashboard-DPT9-Z9X.js";
...
function h({ data: e, options: n }) {
	...
	return /* @__PURE__ */ o("div", {
		...
		children: h.map((e) => {
			let t = f(e.side), n = e._receivedAt > S && x.current ? "bg-sky-500/10" : t.row;
			return /* @__PURE__ */ s("div", {
				className: `grid grid-cols-[64px_1fr_auto_auto] gap-2 px-2 py-0.5 border-b border-zinc-800/40 transition-colors duration-500 ${n}`,
				children: [
					/* @__PURE__ */ o("span", {
