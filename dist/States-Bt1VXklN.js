...
}), J = n(function({ icon: t, tone: n, state: r, title: i, description: a, error: o, actions: s, primaryAction: c, compact: d, className: f, ...p }, m) {
	return /* @__PURE__ */ u("div", {
		role: "status",
		...p,
		ref: m,
		className: e("mtc-state", f),
		"data-compact": d,
		"data-intent": n,
		"data-state": r,
		children: [
...
}), Y = n(function({ resource: e, title: t, description: n, ...r }, i) {
	let a = S();
	return /* @__PURE__ */ l(J, {
		...r,
		ref: i,
...
}), X = n(function({ onSignIn: e, signInLabel: t, title: n, description: r, ...i }, a) {
	let o = S();
	return /* @__PURE__ */ l(J, {
		...i,
		ref: a,
...
}), Z = n(function({ onContinue: e, continueLabel: t, title: n, description: r, ...i }, a) {
	let o = S();
	return /* @__PURE__ */ l(J, {
		...i,
		ref: a,
...
}), Q = n(function({ resource: e, title: t, description: n, ...r }, i) {
	let a = S();
	return /* @__PURE__ */ l(J, {
		...r,
		ref: i,
...
}), $ = n(function({ retryAfterMs: e, onRetry: t, retryLabel: n, title: r, description: i, error: a, ...o }, s) {
	let c = S(), { locale: u } = x(), d = e ?? a?.retryAfterMs;
	return /* @__PURE__ */ l(J, {
		...o,
		ref: s,
		error: a,
		...
		description: i ?? (d === void 0 ? c("error.rate_limited.description") : c("error.rate_limited.retryIn", { duration: M(d, { locale: u }) })),
		primaryAction: t && /* @__PURE__ */ l(R, {
			size: "small",
			onClick: t,
			children: n ?? c("state.retry")
		})
	});
}), ee = n(function({ lastUpdated: e, now: t, onRefresh: n, title: r, description: i, ...a }, o) {
	let s = S(), { locale: c } = x();
	return /* @__PURE__ */ l(J, {
		...a,
		ref: o,
		...
		description: i ?? (e === void 0 ? s("state.stale.generic") : s("state.stale.description", { time: j(e, {
			locale: c,
			now: t
		}) })),
		primaryAction: n && /* @__PURE__ */ l(R, {
			size: "small",
			onClick: n,
			children: s("state.stale.action")
		})
	});
}), te = n(function({ error: e, resource: t, onRetry: n, onRenewSession: r, ...i }, a) {
	switch (e.kind) {
		case "unauthenticated": return /* @__PURE__ */ l(Z, {
			...i,
			ref: a,
			error: e,
			onContinue: r ?? n
		});
		case "forbidden": return /* @__PURE__ */ l(Y, {
			...i,
			ref: a,
			error: e,
			resource: t
		});
		case "not_found": return /* @__PURE__ */ l(Q, {
			...i,
			ref: a,
			error: e,
			resource: t
		});
		case "rate_limited": return /* @__PURE__ */ l($, {
			...i,
			ref: a,
			error: e,
			onRetry: n
		});
		default: return /* @__PURE__ */ l(q, {
			...i,
			ref: a,
			error: e,
			onRetry: n
...
//#endregion
export { h as A, y as C, d as D, b as E, f as O, C as S, S as T, k as _, Q as a, j as b, X as c, R as d, B as f, O as g, L as h, H as i, m as k, te as l, I as m, V as n, $ as o, z as p, q as r, Z as s, Y as t, ee as u, M as v, x as w, w as x, E as y };
