...
var z = (e, t) => h(() => e().then((e) => ({ default: e[t] }))), B = /* @__PURE__ */ new Map([
	["timeseries", z(() => import("./Timeseries-CGVEJ2Ns.js").then((e) => e.n), "Timeseries")],
	["candlestick", z(() => import("./Candlestick-BnAlyzts.js").then((e) => e.n), "Candlestick")],
	["table", z(() => import("./DataTable-Cy132F7K.js").then((e) => e.n), "DataTable")],
	["metric", z(() => import("./Metric-CsN3_xvB.js").then((e) => e.n), "Metric")],
	["text", z(() => import("./Text-DV9dBZfB.js").then((e) => e.n), "Text")],
	["conversation", z(() => import("./ConversationImpl-CpIMUBn0.js"), "ConversationImpl")],
	["prompt", z(() => import("./Prompt-DHfUhD8a.js").then((e) => e.n), "Prompt")],
	["gauge", z(() => import("./Gauge-CaJOZz8z.js").then((e) => e.n), "Gauge")],
	["distribution", z(() => import("./Distribution-BRlBQGD-.js").then((e) => e.n), "Distribution")],
	["heatmap", z(() => import("./Heatmap-q7lRSmdg.js").then((e) => e.n), "Heatmap")],
	["events", z(() => import("./Events-CI2wDj7N.js").then((e) => e.n), "Events")],
	["catalog", z(() => import("./Catalog-U1nvgiPg.js").then((e) => e.n), "Catalog")],
	["asset_catalog", z(() => import("./AssetCatalog-CHmhsski.js").then((e) => e.n), "AssetCatalog")],
	["object_view", z(() => import("./ObjectView-Ds2GdVo3.js").then((e) => e.n), "ObjectView")],
	["code_browser", z(() => import("./CodeBrowser-CqQXwLwJ.js").then((e) => e.n), "CodeBrowser")],
	["record_grid", z(() => import("./RecordGrid-DcxqICgq.js").then((e) => e.n), "RecordGrid")],
	["record_board", z(() => import("./RecordBoard-B-fESxC1.js").then((e) => e.n), "RecordBoard")],
	["record_calendar", z(() => import("./RecordCalendar-CkNVZutN.js").then((e) => e.n), "RecordCalendar")],
	["record_form", z(() => import("./RecordForm-BgdL52Wh.js").then((e) => e.n), "RecordForm")],
	["action_form", z(() => import("./ActionForm-BRVtWD4u.js").then((e) => e.n), "ActionForm")],
	["orderbook", z(() => import("./OrderBook-BZT1WT7-.js").then((e) => e.n), "OrderBook")],
	["depth_chart", z(() => import("./DepthChart-D7om9kqU.js").then((e) => e.n), "DepthChart")],
	["paired_grid", z(() => import("./PairedGrid-B7jnU-6X.js").then((e) => e.n), "PairedGrid")],
	["trade", z(() => import("./Trade-ruPlZSCk.js").then((e) => e.n), "Trade")],
	["ticker", z(() => import("./Ticker-CQ-mb7Pk.js").then((e) => e.n), "Ticker")],
	["volume_profile", z(() => import("./VolumeProfile-C1quLLR0.js").then((e) => e.n), "VolumeProfile")],
	["stat_strip", z(() => import("./StatStrip-in8t0Utm.js").then((e) => e.n), "StatStrip")],
	["bar_chart", z(() => import("./BarChart-BPzchomM.js").then((e) => e.n), "BarChart")],
	["scatter", z(() => import("./Scatter-BpW4CcUM.js").then((e) => e.n), "Scatter")],
	["clock", z(() => import("./Clock-Cc9ABoWJ.js").then((e) => e.n), "Clock")],
	["treemap", z(() => import("./Treemap-CrNkpihz.js").then((e) => e.n), "Treemap")],
	["image", z(() => import("./Image-B-vfK2qq.js").then((e) => e.n), "Image")],
	["iframe", z(() => import("./Iframe-gtu6xpsN.js").then((e) => e.n), "Iframe")],
	["histogram", z(() => import("./Histogram-6XVYATFZ.js").then((e) => e.n), "Histogram")],
	["section", z(() => import("./Section-Cpjr_7EV.js").then((e) => e.n), "Section")],
	["area_chart", z(() => import("./AreaChart-CQim9wlB.js").then((e) => e.n), "AreaChart")],
	["slider", z(() => import("./Slider-DsP8fgqt.js").then((e) => e.n), "Slider")],
	["select", z(() => import("./Select-CXVF-BDo.js").then((e) => e.n), "Select")],
	["boxplot", z(() => import("./Boxplot-CX6oqjv0.js").then((e) => e.n), "Boxplot")],
	["radar", z(() => import("./Radar-BcHmosJn.js").then((e) => e.n), "Radar")],
	["dag", z(() => import("./Dag-C2y3L_lR.js").then((e) => e.n), "Dag")],
	["geo_map", z(() => import("./GeoMap-CPVIJK01.js").then((e) => e.n), "GeoMap")],
	["media_gallery", z(() => import("./MediaGalleryImpl-iP83IZ-l.js"), "MediaGalleryImpl")],
	["multi_select", z(() => import("./MultiSelect-C_kws22B.js").then((e) => e.n), "MultiSelect")],
	["json", z(() => import("./Json-A-LW-60i.js").then((e) => e.n), "Json")],
	["sparkline", z(() => import("./Sparkline-U5c0VWWZ.js").then((e) => e.n), "Sparkline")],
	["action_log", z(() => import("./ActionLog-xxWFTDia.js").then((e) => e.n), "ActionLog")],
	["alert_log", z(() => import("./AlertLog-BAUT-z7n.js").then((e) => e.n), "AlertLog")],
	["tape", z(() => import("./Tape-KWfahcka.js").then((e) => e.n), "Tape")],
	["file_browser", z(() => import("./FileBrowser-zTo_vBwJ.js").then((e) => e.n), "FileBrowser")]
