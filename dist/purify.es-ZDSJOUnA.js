...
function on(n, o) {
  ...
  if (a != null) {
    ...
    try {
      if (p = (a = a.call(n)).next, o !== 0) for (; !(I = (s = p.call(a)).done) && (te.push(s.value), te.length !== o); I = !0) ;
    } catch (Le) {
      ne = !0, f = Le;
    } finally {
      try {
...
let D = Object.freeze, C = Object.seal, ee = Object.create, Ft = typeof Reflect < "u" && Reflect, Ke = Ft.apply, Ze = Ft.construct;
D || (D = function(o) {
  return o;
});
C || (C = function(o) {
