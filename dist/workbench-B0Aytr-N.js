import { o as e, s as t } from "./States-CBV4O5lL.js";
...
var _ = s(function({ size: e = "medium", density: t, invalid: n, className: r, ...i }, o) {
...
function y({ label: e, children: t, id: n, description: r, error: i, required: s, className: l }) {
...
var b = s(function({ label: e, description: n, density: r, className: i, ...o }, s) {
...
}), x = s(function({ label: e, description: t, density: n, className: r, ...i }, o) {
	return /* @__PURE__ */ g("label", {
...
}), S = s(function({ checked: e, onCheckedChange: t, label: n, description: r, density: i, className: o, ...s }, c) {
	return /* @__PURE__ */ g("label", {
...
}), C = s(function({ value: e, onValueChange: n, options: r, placeholder: i = "Select…", disabled: o, required: s, name: c, id: m, "aria-label": _, "aria-labelledby": v, "aria-describedby": y, "aria-invalid": b, invalid: x, size: S = "medium", density: C, className: w, emptyMessage: T = "No matching options" }, E) {
...
}), w = s(function({ intent: e = "neutral", size: n = "small", onRemove: r, removeLabel: i = "Remove", className: o, children: s, ...c }, l) {
...
}), T = s(function({ intent: e = "neutral", size: t = "small", dot: n, className: r, children: i, ...o }, s) {
	return /* @__PURE__ */ g("span", {
		...o,
		ref: s,
...
}), E = s(function({ title: e, intent: n = "info", icon: r, actions: i, className: o, children: s, role: c, ...l }, u) {
...
function D({ content: e, children: t, placement: n = "top", disabled: r, className: s }) {
	let c = u(), [l, d] = i({
		value: void 0,
		defaultValue: !1
	});
...
function O({ trigger: e, triggerAriaLabel: t, children: n, title: r, open: o, defaultOpen: s = !1, onOpenChange: c, placement: l = "bottom-start", disabled: d, className: p }) {
...
function k({ label: e, trigger: t, items: n, open: r, defaultOpen: o = !1, onOpenChange: s, align: c = "start", disabled: l, className: u }) {
	...
	return P(v, d, () => b(!1)), /* @__PURE__ */ g("div", {
		ref: d,
		...
		children: [/* @__PURE__ */ h("button", {
			...
			onKeyDown: (e) => {
				(e.key === "ArrowDown" || e.key === "ArrowUp") && (e.preventDefault(), _(F(n, e.key === "ArrowDown" ? 1 : -1)), y(!0));
			},
			children: t
		}), v && /* @__PURE__ */ h(j, {
			label: e,
...
var A = s(function({ label: e, items: t, children: n, className: r, tabIndex: o = 0, onContextMenu: s, onKeyDown: c, ...l }, u) {
	let d = f(null), p = f({
		x: 0,
		y: 0
	}), [m, _] = i({
...
function j({ label: e, items: t, initialIndex: n, onClose: r, align: i = "start", style: a }) {
	let o = f(null);
	l(() => {
...
var M = s(function({ open: i, onOpenChange: o, title: s, description: c, children: l, footer: d, size: p = "medium", dismissible: m = !0, initialFocusRef: _, className: v }, y) {
...
}), N = s(function({ open: i, onOpenChange: o, title: s, description: c, children: l, footer: d, side: p = "right", width: m = 420, dismissible: _ = !0, initialFocusRef: v, className: y }, b) {
...
var L = s(function({ items: e, value: t, onValueChange: n, label: r, orientation: i = "horizontal", activationMode: o = "automatic", density: s, keepMounted: c = !1, className: l, ...d }, p) {
...
}), R = s(function({ items: e, label: n = "Breadcrumbs", maxItems: r, className: i, ...o }, s) {
	let c = z(e, r);
...
var B = s(function({ density: e, fullHeight: t = !0, className: n, children: r, ...i }, o) {
	return /* @__PURE__ */ h("div", {
		...i,
		ref: o,
...
}), V = s(function({ label: e = "Toolbar", start: t, end: n, density: r, sticky: i, className: o, children: s, ...c }, l) {
	return /* @__PURE__ */ g("div", {
		...c,
		ref: l,
		role: "toolbar",
...
}), H = s(function({ label: e, header: t, footer: n, width: r = 280, collapsed: i = !1, side: o = "left", className: s, children: c, style: l, ...u }, d) {
	let f = {
...
}), U = s(function({ label: e, title: t, subtitle: n, actions: r, footer: i, width: o = 320, open: s = !0, className: c, children: l, style: u, ...d }, f) {
	let p = {
...
}), W = s(function({ primary: e, secondary: t, orientation: n = "horizontal", primaryPane: r = "start", size: o, defaultSize: s = 30, onSizeChange: c, minSize: l = 15, maxSize: u = 85, step: d = 5, disabled: p, stackOnNarrow: m = !0, separatorLabel: _ = "Resize panes", className: v, style: y, ...b }, x) {
	let S = f(null), C = f(!1), [w, T] = i({
		value: o,
		defaultValue: s,
		onChange: c
	}), E = Math.min(l, u), D = Math.max(l, u), O = Number.isFinite(d) && d !== 0 ? Math.abs(d) : 1, k = G(w, E, D), A = (e) => {
		...
		T(G(a, E, D));
	}, M = (e) => T(G(k + e, E, D)), N = r === "start" ? k : 100 - k, P = 100 - N;
	return /* @__PURE__ */ g("div", {
		...b,
		ref: A,
...
var K = s(function({ items: e, label: n, selectedId: r, onSelectionChange: i, expandedIds: o, onExpandedChange: s, density: c, className: u, ...m }, _) {
	let v = d(() => q(e, o), [e, o]), y = f(/* @__PURE__ */ new Map()), [b, x] = p(r ?? v.find((e) => !e.item.disabled)?.item.id);
	l(() => {
			...
			return /* @__PURE__ */ g("div", {
				...
				children: [
					/* @__PURE__ */ h("button", {
						...
						tabIndex: -1,
						"aria-label": a ? `${s ? "Collapse" : "Expand"} ${J(n.label)}` : void 0,
...
function q(e, t, n = 1, r, i = /* @__PURE__ */ new Set()) {
	let a = [];
	return e.forEach((o, s) => {
		o.id && !i.has(o.id) && (i.add(o.id), a.push({
			...
			position: s + 1,
			setSize: e.length
		}), o.children?.length && t.has(o.id) && a.push(...q(o.children, t, n + 1, o.id, i)));
	}), a;
}
function J(e) {
...
var Y = s(function({ items: e, properties: t, density: n, emptyValue: r = "—", className: i, ...o }, s) {
	...
	return /* @__PURE__ */ h("dl", {
		...
		children: c.map((e, t) => /* @__PURE__ */ g("div", {
			...
			children: [/* @__PURE__ */ g("dt", { children: [/* @__PURE__ */ h("span", { children: e.label }), e.description && /* @__PURE__ */ h("small", { children: e.description })] }), /* @__PURE__ */ h("dd", { children: $(e.value, r) })]
		}, e.id ?? t))
	});
}), X = 5e3;
function Z(e) {
...
function $(e, t) {
	...
	if (c(e)) return e;
	if (Z(e)) return Q(e);
	if (Array.isArray(e) && e.every(Z)) {
		if (e.length === 0) return t;
		let n = e.map(Q).join(", ");
		return n.length > X ? `${n.slice(0, X)}…` : n;
	}
	try {
		let t = JSON.stringify(e);
		return typeof t == "string" ? /* @__PURE__ */ h("code", { children: t.length > X ? `${t.slice(0, X)}…` : t }) : String(e);
	} catch {
		return String(e);
	}
}
//#endregion
export { x as C, _ as S, v as T, E as _, U as a, C as b, R as c, M as d, N as f, T as g, D as h, B as i, L as l, O as m, K as n, H as o, k as p, W as r, V as s, Y as t, A as u, w as v, S as w, y as x, b as y };
