...
describe('PalantirFoundationShowcase', () => {
  ...
  it('server-renders readiness, Compass, data integration, and repository anatomy', () => {
    ...
    expect(coverage).toContain('Platform capability map')
    expect(coverage).toContain('Operational apps')
    expect(coverage).toContain('Notes &amp; spreadsheets')
    expect(coverage).toContain('Delivery, marketplace &amp; releases')
    ...
    expect(data).toContain('Data connections')
