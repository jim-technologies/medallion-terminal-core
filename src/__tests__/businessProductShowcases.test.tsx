...
} from '../../examples/clones/airtable/AirtableShowcase'
import {
  ...
  type HubSpotContact,
} from '../../examples/clones/hubspot/HubSpotShowcase'
import {
...
} from '../../examples/clones/shared/ProductShowcasePrimitives'

describe('business product showcase primitives', () => {
  it('formats presentation values without product-specific data helpers', () => {
    expect(productShowcaseInitials(CLONE_DEMO_IDENTITY.company)).toBe('JT')
    expect(formatProductCurrency(86_400)).toBe('$86,400')
    expect(formatProductCurrency(174_620, { compact: true })).toBe('$174.6K')
    expect(formatProductPercent(0.725, 1)).toBe('72.5%')
  })
})
